...
* **VPC**를 선택합니다.
  ...
  > [주의] **NHN Cloud Zone**에 정보가 등록되어 있는 **VPC**만 온프레미스 네트워크와 통신이 가능합니다. 온프레미스 네트워크와 통신을 원하는 **VPC**의 경우 **코로케이션 게이트웨이 생성**을 하기 전에 **NHN Cloud Zone**생성을 원하는 경우 NHN Cloud 고객 센터 [1:1문의](https://www.toast.com/kr/support/inquiry)로 문의하시기 바랍니다.
