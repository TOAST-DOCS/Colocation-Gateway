...
코로케이션 게이트웨이로 부터 유입된 모든 트래픽을 처리할 VM Instance의 Port 및 Virtual IP Port를 지정할 수 있습니다. 라우트의 Gateway가 되는 VM Instance에는 Network Virtual Appliance를 배치하여 VM Instance내부에서 트래픽 제어를 하고 피어링을 통해서 다른 VPC로 트래픽을 전달할 수 있습니다.<br>
